...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-60 bg-charcoal min-h-screen flex flex-col flex-shrink-0">
      {/* Logo */}
      ...
      <div className="p-3 border-t border-white/10">
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-white/60 hover:text-white hover:bg-white/10 transition-all mb-1"
        >
