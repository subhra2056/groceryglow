      ...
      {searchOpen && (
        ...
        >
          <form
            ...
            className="w-full max-w-xl bg-white rounded-2xl shadow-card-hover overflow-hidden"
          >
            ...
            <div className="border-t border-gray-100 px-5 py-3 bg-gray-50 flex gap-2">
              ...
              {['Organic Bananas', 'Fresh Tomatoes', 'Whole Milk', 'Sourdough Bread'].map((q) => (
                <button
                  key={q}
                  type="button"
                  onClick={() => {
                  ...
                  className="text-xs text-forest-green bg-green-50 hover:bg-green-100 px-2.5 py-1 rounded-full transition-colors"
                >
                  {q}
                </button>
              ))}
          ...
          <div className="border-t border-gray-100 p-5">
            {user ? (
              <button
                ...
                className="flex items-center gap-2 w-full text-sm text-red-500 font-medium"
              >
